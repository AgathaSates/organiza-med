...
import { CadastrarPacienteModel, CadastrarPacienteResponseModel } from '../pacientes.models';
...
export class CadastrarPaciente {
  ...
  protected readonly pacienteService = inject(PacientesService);
  ...
  public cadastrar() {
    ...
    const pacienteObserver: Observer<CadastrarPacienteResponseModel> = {
      next: () =>
    ...
    this.pacienteService.cadastrar(pacienteModel).subscribe(pacienteObserver);
  }
}
